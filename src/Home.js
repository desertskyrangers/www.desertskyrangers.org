			...
			<div className='content'>
				<div className="row">
					...
					<div className="column">
						...
						<h5><a href="https://goo.gl/maps/oLuZKi1qZzowQPj58"><FontAwesomeIcon icon={faMapMarkerAlt}/></a> Pony Express Elementary (some Saturdays)</h5>
						<p>
						...
						<h5><a href="https://goo.gl/maps/WfuVVZqe4Qv32PX27"><FontAwesomeIcon icon={faMapMarkerAlt}/></a> Wardle Fields Regional Park (some Saturdays)</h5>
						<p>
